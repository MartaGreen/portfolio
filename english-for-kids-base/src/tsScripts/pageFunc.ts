...
const openMainPage = () => {
    ...
    const categoriesPage: HTMLDivElement = document.querySelector(".categoriesPageCont");
    mainPageNav.addEventListener("click", () => {
        const activeNavPage: HTMLLIElement = document.querySelector(".navMenuItemActive");
