...
function createRegisterBtn() {
    const registerBtn = createBtn("registerBtn", "register");
...
const pageMain = () => {
    ...
    getAllCategories().then((categoriesData) => {
        ...
        categoriesData.forEach((categoryData) => {
            ...
            const category = new CategoryName(categoryData.imgSrc, categoryName);
            const categoryImg = category.render();
            CATEGORIES_NAMES.push(category);
            CATEGORY_CARDS[categoryName] = [];
            getAllCategoryCards(categoryName).then((cardsData) => {
                cardsData.forEach((cardData) => {
                    const createdCard = new CategoryCard(cardData.imgSrc, cardData.cardName, cardData.translate, cardData.soundSrc);
...
const createFooter = () => {
    ...
    const footerItemCont = document.createElement("div");
