...
export function createFormField(type, placeholder, cls, fieldName) {
...
export const createCloseFormBtn = () => {
    ...
    closeFormBtn.addEventListener("click", (e) => {
        ...
        const formCont = document.querySelector(".userFormBg");
        formCont.remove();
    });
    return closeFormBtn;
};
export const createCancelBtn = () => {
    const cancelBtn = createBtn("cancelBtn submitFormBtn", "cancel");
...
export function submitFunc(btn) {
    btn.addEventListener("click", () => {
        ...
        if (passField.value === confirmField.value) {
            ...
            passField.classList.add("different");
            confirmField.classList.add("different");
        }
    });
}
