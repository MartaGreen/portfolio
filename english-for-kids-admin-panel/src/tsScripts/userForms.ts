...
export function submitFunc(btn: HTMLInputElement) {
  btn.addEventListener("click", () => {
    const passField: HTMLInputElement = document.querySelector(".passwordField");
    const confirmField: HTMLInputElement = document.querySelector(".confirmField");
